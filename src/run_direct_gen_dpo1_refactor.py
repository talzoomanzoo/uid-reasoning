...
async def main(args):
    ...
    # async def first_stage_generate_outputs_prev(llm, input_batches, sample_limit, batch_size):
    #     output_list = []
    ...
    # async def first_stage_generate_outputs_no_index(llm, input_batches, sample_limit):
    #     # Flatten input: replicate each prompt sample_limit times
    #     all_prompts = []
    #     for prompt in tqdm(input_batches):
    ...
    #         llm.generate,
    #         all_prompts,
    #         sampling_params=first_stage_sampling_params
    #     )
    
    #     return output_list

    async def first_stage_generate_outputs(llm, input_batches, sample_limit):
    ...
    t_start = time.time()
    output_list = await first_stage_generate_outputs(llm, input_list, sample_limit)
