...
def parse_args():
    ...
    parser.add_argument("--prompt_file", type=str, default="./prompts/med_expert.json")
    parser.add_argument("--output_dir", type=str, default="./outputs/expert/DeepSeek-R1-Distill-Llama-8B/deepseek-jama_full_test")
    ...
    if args.output_dir is None:
        args.output_dir = f"./outputs/med_expert/{args.model_name.split('/')[-1].split('.')[0]}/{args.input_file.split('/')[-1].split('.')[0]}"
    return args
